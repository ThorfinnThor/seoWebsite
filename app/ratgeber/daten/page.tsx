...
export const metadata = createPageMetadata({
  ...
  description: "Eigene Auswertungen geprüfter Produktdaten zu Gartenhäusern, Bodenbelägen und Luftentfeuchtern mit Methodik, Datenstand und sichtbaren Grenzen.",
  path: PATH,
});
