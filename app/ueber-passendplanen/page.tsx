...
export default function UeberPage() {
  return (
    <article className="about-page">
      ...
      <section className="method-detail"><div><p className="eyebrow">Was heute verfügbar ist</p><h2>Rechner, Produktdaten und eigene Auswertungen greifen ineinander.</h2></div><div><p>PassendPlanen bietet zwölf kostenlose Planungswerkzeuge. Dazu gehören Rechner für Haus und Garten sowie die Auswahl und Speicherplanung von Sicherheitskameras. Geprüfte Produktdaten ergänzen die Berechnung dort, wo ein passendes Angebot belastbar eingeordnet werden kann.</p><p>In {DATA_REPORTS.length} Datenauswertungen werden Sortiment, technische Eigenschaften, Preise und Datenlücken sichtbar gemacht. Diese Seiten sind keine unabhängigen Labortests und bilden nicht den gesamten Markt ab.</p><Link className="text-link" href="/ratgeber/daten/">Datenauswertungen ansehen →</Link></div></section>
