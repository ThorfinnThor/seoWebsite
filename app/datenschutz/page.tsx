  ...
  return (
    <LegalPage title="Datenschutzerklärung" intro="Diese Erklärung beschreibt den aktuellen, datensparsamen Stand der statischen Website. Stand: 9. August 2026.">
      ...
      <section>
        ...
        <p>PassendPlanen speichert derzeit keine personenbezogenen Planerprofile. Technische Protokolldaten werden durch den Hostinganbieter nur so lange verarbeitet, wie dies für Betrieb und Sicherheit erforderlich ist; die konkrete Dauer richtet sich nach Tarif und Konfiguration und wird vor dem Produktivbetrieb verifiziert.</p>
      </section>
      <section>
