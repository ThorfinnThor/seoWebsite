...
export default function UeberPage() {
  return (
    <article className="about-page">
      ...
      <section className="method-detail"><div><p className="eyebrow">Im Aufbau</p><h2>Was heute bereits funktioniert.</h2></div><div><p>Sechs kostenlose, browserbasierte Planer; redaktionelle Ratgeber; deterministische Regeln; validierte statische Datenformate und ein sicherer Leerzustand ohne ungeprüfte Angebote.</p><p>Als Nächstes folgen geprüfte Produktdaten und klar gekennzeichnete Partnerlinks. Der endgültige Markenname und eine eigene Domain werden später festgelegt.</p><Link className="text-link" href="/methodik/">Methodik im Detail →</Link></div></section>
    </article>
  );
}
