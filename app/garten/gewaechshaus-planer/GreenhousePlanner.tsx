...
export function GreenhousePlanner() {
  ...
  return <CalculatorShell planner="greenhouse" step={step} totalSteps={4} title={TITLES[step - 1]} label="Gewächshaus-Planer" onReset={() => { resetInput(); setStep(1); resetValidation(); }}>
    ...
    {step === 4 && plan && <div className="results greenhouse-results" aria-live="polite">
      ...
      <ProjectProductRecommendations requirements={{ vertical: "greenhouse", requiredKinds: ["base", "ventilation", "irrigation", "bench", "shade", "kit"], widthM: input.widthM, lengthM: input.lengthM, footprintM2: plan.footprintM2, baseLengthM: plan.baseLengthWithReserveM, glazing: input.glazing, roofVentCount: input.roofVentCount, showCompleteKits: true }} />
