...
export default function Page() {
  return <GuidePage path="/garten/carport-groesse/"
    ...
    sections={[
      ...
      { title: "Die Zufahrt kann mehr Raum verlangen", paragraphs: ["Bei gerader Einfahrt ist der Stellraum einfacher erreichbar als nach einer engen Kurve. Seitliche Mauern, Torpfosten und öffentliche Gehwege beeinflussen Anfahrwinkel und Rangierweg.", "Übertrage den Zielraum in einen Grundstücksplan und zeichne die Anfahrt. Erst danach lässt sich beurteilen, ob Pfostenraster und Dachform eines konkreten Modells praktisch funktionieren."] },
    ]}
  />;
}
