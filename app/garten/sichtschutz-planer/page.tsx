...
export const metadata: Metadata = { title: "Sichtschutz- und Zaunfeld-Planer", description: "Sichtschutzfelder, Tor-Module, Pfosten und Rasteranpassung für eine gerade Strecke nachvollziehbar abschätzen." };
