...
export default function GardenPage() {
  return <>
    ...
    <section className="section">
      ...
      <Link className="planner-banner planner-banner--secondary planner-banner--carport" href="/garten/carport-planer/"><div><span className="status-pill">Neu</span><h2>Den lichten Stellraum eines Carports passend planen.</h2><p>Fahrzeugmaße, Bewegungsraum, Zufahrt, Stauraum und Dachwasser zu einem klaren Platzrahmen verbinden.</p></div><span className="button button--light">Carport planen →</span></Link>
      ...
      <div className="content-cluster-heading"><p className="eyebrow">Bewässerung Wissen</p><h2>Komponenten passend zum gemessenen Bedarf.</h2></div>
