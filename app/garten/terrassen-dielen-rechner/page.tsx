...
export default function Page() {
  return <>
    ...
    <section className="planner-hero"><Breadcrumbs items={[{label:"Start",href:"/"},{label:"Garten",href:"/garten/"},{label:"Terrassendielen-Rechner"}]} /><div className="planner-hero-grid"><div><p className="eyebrow">Mengenschätzung · keine Ausführungsplanung</p><h1>Berechne den Materialrahmen für deine <em>Terrasse</em>.</h1><p>Fläche, Verlegerichtung, Dielenmaß, Fuge und Hersteller-Auflagerabstand werden zu einem nachvollziehbaren Mengenplan verbunden.</p></div><div className="hero-facts"><div><strong>4</strong><span>übersichtliche Schritte</span></div><div><strong>lfm</strong><span>Belag und Unterkonstruktion</span></div><div><strong>klar</strong><span>Verschnitt und Planungsgrenzen</span></div></div></div></section>
