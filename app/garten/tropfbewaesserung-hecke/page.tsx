...
export default function Page() {
  return <GuidePage
    ...
    limitation="MachPlan berechnet keine pflanzenspezifische Wassermenge. Boden, Wetter, Alter der Pflanzen, Tropferabstand und Herstellerangaben bestimmen Laufzeit und Auslegung."
    sections={[
      ...
      {title:"Eigene Zone für eigene Bedürfnisse",paragraphs:["Hecken, Beete und Rasen haben unterschiedliche Ausbringungsarten und Laufzeiten. Sie sollten deshalb nicht automatisch in derselben Steuerungszone liegen.","Bei automatischer Steuerung plant MachPlan mindestens eine Zone pro aktiver Nutzungskategorie. Die genaue Aufteilung bleibt von Durchfluss und System abhängig."]},
    ]}
  />;
}
