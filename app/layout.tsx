      ...
      <body>
        ...
        <footer className="site-footer">
          <div className="footer-grid">
            <div><Link className="brand brand--footer" href="/"><img className="brand-icon-image" src="/brand/passendplanen-icon.png" width="512" height="512" alt="" /><span>PassendPlanen</span></Link><p>Klare Entscheidungen für Haus und Garten. Transparent und nachvollziehbar.</p></div>
