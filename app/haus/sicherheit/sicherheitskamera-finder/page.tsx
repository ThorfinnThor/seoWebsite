...
export default function Page() {
  return <>
    ...
    <section className="section related-guides"><div className="section-heading"><div><p className="eyebrow">Vor dem Produktvergleich</p><h2>Fünf Entscheidungen brauchen etwas mehr Kontext.</h2></div><Link className="text-link" href="/ratgeber/sicherheitskameras/">Alle Kamera Ratgeber →</Link></div><div className="guide-grid">
      ...
      <Link className="guide-card" href="/haus/sicherheit/sicherheitskamera-speicher-rechner/"><span>Speicher</span><h3>Aufbewahrung berechnen</h3><p>Bitrate, Aufnahmezeit und gewünschte Tage in Speicherbedarf übersetzen.</p></Link>
    </div></section>
