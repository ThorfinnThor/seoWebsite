...
export default function HousePage() {
  return <>
    ...
    <section className="section area-grid">
      ...
      <Link className="area-card" href="/haus/sicherheit/sicherheitskamera-finder/"><span className="feature-icon" aria-hidden="true"><PlannerIcon name="security-camera" /></span><div><p className="eyebrow">Sicherheit</p><h2>Sicherheitskameras</h2><p>Einsatzort, Verbindung, Stromversorgung, Auflösung und benötigte Anzahl vor dem Kauf gemeinsam prüfen.</p><span className="card-link">Kamera Finder öffnen →</span></div></Link>
    </section>
  </>;
}
