...
export default function Page() {
  return <>
    ...
    <section className="planner-hero"><Breadcrumbs items={[{label:"Start",href:"/"},{label:"Haus",href:"/haus/"},{label:"Boden",href:"/haus/boden/"},{label:"Bodenbelag-Rechner"}]} /><div className="planner-hero-grid"><div><p className="eyebrow">Mengenschätzung · keine Verlegefreigabe</p><h1>Berechne Pakete und Zubehör für deinen <em>Bodenbelag</em>.</h1><p>Rechteckige Teilflächen, feste Abzüge, Dielen- und Paketmaß werden zu einem nachvollziehbaren Materialrahmen für Laminat, Klick-Vinyl oder Fertigparkett.</p></div><div className="hero-facts"><div><strong>4</strong><span>übersichtliche Schritte</span></div><div><strong>m²</strong><span>Nettofläche und Reserve</span></div><div><strong>voll</strong><span>auf ganze Pakete gerundet</span></div></div></div></section>
