...
export default function Page() {
  return <>
    ...
    <section className="planner-hero"><Breadcrumbs items={[{label:"Start",href:"/"},{label:"Raumklima",href:"/haus/raumklima/"},{label:"Luftentfeuchter-Rechner"}]} /><div className="planner-hero-grid"><div><p className="eyebrow">Auswahlhilfe · keine Feuchtediagnose</p><h1>Dimensioniere einen Luftentfeuchter für deinen <em>Raum</em>.</h1><p>Wir verbinden Raumgröße und Nutzung mit geprüften Herstellerangaben – ohne eine scheinpräzise bauphysikalische Berechnung.</p></div><div className="hero-facts"><div><strong>4</strong><span>übersichtliche Schritte</span></div><div><strong>m³</strong><span>Raumvolumen berücksichtigt</span></div><div><strong>klar</strong><span>Grenzen und Unsicherheiten</span></div></div></div></section>
