  ...
  return (
    <>
      ...
      <section className="section section--projects">
        <div className="section-heading"><p className="eyebrow">Der erste Planer</p><h2>Dein Gartenhaus beginnt nicht im Warenkorb.</h2><p>Berechne sinnvolle Mindestfläche, Türbreite und passende Modelle anhand deiner realen Stellfläche.</p></div>
        <Link className="feature-card" href="/garten/gartenhaus-planer/">
          <div className="feature-icon" aria-hidden="true">⌂</div><div><span className="status-pill">Jetzt verfügbar</span><h3>Gartenhaus-Planer</h3><p>Für Fahrräder, Geräte, Rasenmäher, Werkbank und Regale.</p><span className="card-link">Projekt starten →</span></div>
        </Link>
      </section>
