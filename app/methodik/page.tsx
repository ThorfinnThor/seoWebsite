...
export default function MethodikPage() {
  return (
    <article className="method-page">
      ...
      <section className="method-detail"><div><p className="eyebrow">Fünf Bereiche</p><h2>Die Regeln passen zum Projekt.</h2></div><div className="method-cards">{methods.map((method) => <article key={method.title}><h3>{method.title}</h3><p>{method.text}</p></article>)}</div></section>
