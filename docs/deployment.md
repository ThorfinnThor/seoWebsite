...
7. Verify `/`, `/rechner/`, `/garten/gartenhaus-planer/`, `/garten/terrassen-dielen-rechner/`, `/garten/sichtschutz-planer/`, `/data/garden-house/catalog.json`, `/sitemap.xml` and `/robots.txt` in Preview before merging.
