...
7. Verify `/`, `/rechner/`, `/garten/gartenhaus-planer/`, `/garten/terrassen-dielen-rechner/`, `/data/garden-house/catalog.json`, `/sitemap.xml` and `/robots.txt` in Preview before merging.
