...
import { availability, isGardenHouseCandidate, merchantDetails, normalizeGardenHouse, parseDimensions, parsePrice, parsePriceFromFields } from "./garden-house-normalizer";
...
describe("price parsing", () => {
  ...
  it("falls back to another current Awin price field", () => expect(parsePriceFromFields("0", "", "1,599.00")).toBe(1599));
});
