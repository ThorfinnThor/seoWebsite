...
const carportGuides = guides(clusters.carport, [
  ...
  {
    slug: "einzelcarport-oder-doppelcarport", title: "Einzelcarport oder Doppelcarport: Maße vergleichen", description: "Einzel- und Doppelcarport vergleichen: Fahrzeugbreite, Türen, Mittelpfosten, Rangieren, Zusatzfläche, Dachwasser, Fundament und Kosten prüfen.", heading: "Einzel- oder Doppelcarport: Fahrzeuge und Bewegungsraum entscheiden", intro: "Zwei Einzelcarports können klare Trennung bieten; ein Doppelcarport vermeidet je nach System störende Mittelpfosten und schafft flexible Fläche.", takeaway: "Zeichne beide Fahrzeuge mit geöffneten Türen und Fahrwegen. Vergleiche lichte Breiten, Pfosten, Dachentwässerung und spätere Nutzbarkeit mit identischen Annahmen. Lege außerdem fest, ob Fahrräder, ein Ladepunkt oder ein drittes Fahrzeug zeitweise erreichbar bleiben müssen. Diese Nebenwege verändern die sinnvoll nutzbare Breite oft stärker als wenige Zentimeter Dachmaß.", scenario: "einen Einzel- oder Doppelcarport", measurement: "Miss beide Fahrzeuge einschließlich Spiegeln und möglicher Dachaufbauten. Zeichne die geöffneten Türen, den gleichzeitigen Ein- und Ausstieg, Fahrräder am Fahrzeug, Zufahrtsbreite, Tor und jede mögliche Pfostenlinie maßstäblich ein. Berücksichtige auch, ob beide Fahrzeuge unabhängig voneinander ausparken können.", calculation: "Zwei je 2,0 m breite Fahrzeuge plus außen je 0,7 m und mittig 1,0 m Bewegungsraum ergeben rund 6,4 m nutzbare Gesamtbreite. Dieser Wert beschreibt die freie Zone zwischen begrenzenden Bauteilen. Pfosten, Seitenwände, Rinne und konstruktive Toleranzen kommen außerhalb oder zusätzlich zu dieser lichten Breite hinzu.", result: "etwa 6,4 m lichte Breite für komfortable parallele Nutzung im Beispiel.", optionA: "Zwei Einzelcarports", optionB: "Ein gemeinsamer Doppelcarport", advice: ["Ein Mittelpfosten kann Türen und Rangieren einschränken. Seine Lage wird mit beiden geöffneten Fahrzeugtüren und dem Anfahrwinkel geprüft.", "Eine große Dachfläche braucht einen klaren Entwässerungsweg. Rinne, Fallrohr, Notüberlauf und zulässige Ableitung werden vor dem Fundament festgelegt.", "Spätere Fahrzeuggrößen, Dachboxen, Ladepunkt und Fahrradzugang werden als Reserve benannt. So bleibt die Stellfläche auch bei veränderter Nutzung erreichbar."], caution: "Größere Spannweiten und Dachflächen verändern Tragwerk, Fundamente und Genehmigungsprüfung wesentlich. Ein gemeinsamer stützenarmer Raum kann alltagstauglicher sein, benötigt aber ein dafür bemessenes System und darf nicht aus einem kleineren Carport abgeleitet werden.",
  },
  {
