...
export const SEO_TOPICS: readonly SeoTopic[] = [
  {
    ...
    intro: "Ein Gartenhaus passt erst dann, wenn Lagergut, Zugang, Bewegungsfläche und Standort gemeinsam funktionieren. Die Ratgeber in diesem Themenbereich beginnen deshalb beim echten Nutzungsprofil und trennen Innenmaß, Sockelmaß, Außenmaß und rechtlich relevante Randbedingungen.",
    plannerHref: "/garten/gartenhaus-planer/",
    plannerLabel: "Gartenhaus-Größe berechnen",
    method: "Miss zuerst vorhandene Gegenstände und die verfügbare Stellfläche. Zeichne Tür, Regale und Bewegungswege ein. Vergleiche konkrete Häuser erst, wenn die erforderliche Innenfläche und die Mindest-Türbreite dokumentiert sind.",
  ...
  },
  {
    ...
    method: "Lege zuerst Geometrie und Verlegerichtung fest. Berechne Reihen und Laufmeter, danach Lieferlängen und Zuschnitt. Unterkonstruktion, Befestigung und Abschlüsse bleiben eigene Materialgruppen.",
  ...
  },
  {
    ...
    plannerLabel: "Carport-Maße bestimmen",
  ...
  },
  {
    ...
    plannerLabel: "Trockenbau-Material berechnen",
